class AiSkillsAT200 < Formula
  ...
  on_macos do
    on_arm do
      on_tahoe :or_newer do
        url "https://github.com/kevin-lee/ai-skills/releases/download/v2.0.0/aiskills-macos-26-arm64"
        sha256 "92637bf4d418a9045198ad9ca5e9f40ca9f4457b9940bb4e3acc75c07c18b46f"
      end
      on_sequoia :or_older do
        url "https://github.com/kevin-lee/ai-skills/releases/download/v2.0.0/aiskills-macos-15-arm64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/kevin-lee/ai-skills/releases/download/v2.0.0/aiskills-linux-arm64"
      sha256 "f35970efe7b86aa4b6a4bb71409a497820cf961bbafbbf8b0405010ae9fbc710"
    end
    on_intel do
      url "https://github.com/kevin-lee/ai-skills/releases/download/v2.0.0/aiskills-linux-x86_64"
