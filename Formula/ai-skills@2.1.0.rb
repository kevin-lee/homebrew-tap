class AiSkillsAT210 < Formula
  ...
  on_macos do
    on_arm do
      on_tahoe :or_newer do
        url "https://github.com/kevin-lee/ai-skills/releases/download/v2.1.0/aiskills-macos-26-arm64"
        sha256 "9c4cc7b445dafe3a7995b9f9cbd9080febe069ca1aa3d2309f14430274081e1a"
      end
      on_sequoia :or_older do
        url "https://github.com/kevin-lee/ai-skills/releases/download/v2.1.0/aiskills-macos-15-arm64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/kevin-lee/ai-skills/releases/download/v2.1.0/aiskills-linux-arm64"
      sha256 "65397521cf489fab07cbc00bd1cd3496aaabff43a17757af82c5d56a9ac2488f"
    end
    on_intel do
      url "https://github.com/kevin-lee/ai-skills/releases/download/v2.1.0/aiskills-linux-x86_64"
