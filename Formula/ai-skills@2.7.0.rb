class AiSkillsAT270 < Formula
  ...
  on_macos do
    on_arm do
      on_tahoe :or_newer do
        url "https://github.com/kevin-lee/ai-skills/releases/download/v2.7.0/aiskills-macos-26-arm64"
        sha256 "28fdd7effecb913317abfc7b77e47a303d70ae04a057b7ece1f6c604e2ee74b4"
      end
      on_sequoia :or_older do
        url "https://github.com/kevin-lee/ai-skills/releases/download/v2.7.0/aiskills-macos-15-arm64"
        sha256 "021ed2b998a73c67349cf847bae13c4cd9972c43b434754244b1497d6f10cb97"
      end
    end
    on_intel do
      url "https://github.com/kevin-lee/ai-skills/releases/download/v2.7.0/aiskills-macos-15-intel"
  ...
  on_linux do
    on_arm do
      url "https://github.com/kevin-lee/ai-skills/releases/download/v2.7.0/aiskills-linux-arm64"
      sha256 "287083898a3797b2e1fb15ddbcb6a152180173d5d59b709bc90af5636f4c893f"
    end
    on_intel do
      url "https://github.com/kevin-lee/ai-skills/releases/download/v2.7.0/aiskills-linux-x86_64"
