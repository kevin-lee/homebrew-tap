class AiSkillsAT011 < Formula
  ...
  on_macos do
    on_arm do
      on_tahoe :or_newer do
        url "https://github.com/kevin-lee/ai-skills/releases/download/v0.1.1/aiskills-macos-26-arm64"
        sha256 "657942e2b715d7c484ab1d30f17b7b4751e5e4ee96da68f9123adc6b4c8df322"
      end
      on_sequoia :or_older do
        url "https://github.com/kevin-lee/ai-skills/releases/download/v0.1.1/aiskills-macos-15-arm64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/kevin-lee/ai-skills/releases/download/v0.1.1/aiskills-linux-arm64"
      sha256 "d3a64d2dac85cee2503ddb95ef908a434ecd852c7fddca7e8a6c2e1c3212fd31"
    end
    on_intel do
      url "https://github.com/kevin-lee/ai-skills/releases/download/v0.1.1/aiskills-linux-x86_64"
